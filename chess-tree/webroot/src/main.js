...
//onlick event for the load button
document.getElementById('loadBranch1').addEventListener('click', () => {
  loadBranch('');
});
document.getElementById('loadBranch2').addEventListener('click', () => {
  loadBranch('1.e4 e5');
});
document.getElementById('loadBranch3').addEventListener('click', () => {
  loadBranch('1.e4 c5');
});
